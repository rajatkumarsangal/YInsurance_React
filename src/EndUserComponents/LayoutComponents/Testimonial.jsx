...
function Testimonial() {
    return (
        <React.Fragment>
            <section className="testimonials scroll_hide">
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-md-12 padding_all_xs">
                            <h1 className="color_grey text-uppercase fontstyle8 main_heading_center">
                                <span id="ctl00_lblPopupTestimonial">Testimonials</span><hr className="hr_yellow" />
                            </h1>
                    ...
                    {/* <!-- .row --> */}
                    <div className="row padding_bottom_md test_row">
                        <section className="center slider center-block slick-initialized slick-slider">
                            <button type="button" data-role="none" className="slick-prev slick-arrow" aria-label="Previous" role="button" style={{display: 'block'}}>
                                    ...
                                    <div className="media test_desc">
                                        ...
                                        <div className="media-body text-justify" data-toggle="modal" data-target="#customer_1">
                                            <h4 className="media-heading">
                                                <span id="">Roshni Jain</span>
                                                <div className="clearfix">
                                                </div>
                                                <small>
                                                    <span id="">January 27,2020</span></small></h4>
                                ...
                                <div className="slick-slide slick-cloned" data-slick-index="-3" aria-hidden="true" tabIndex="-1">
                                        <div className="media test_desc">
                                            <div className="">
                                                ...
                                                <div className="media-body  text-justify" data-toggle="modal" data-target="#customer_1">
                                                    <h4 className="media-heading">
                                                        <span id="">Rahul Sharma</span>
                                                        <div className="clearfix">
                                                        </div>
                                                        <small>
                                                            <span id="">January 10,2019</span></small></h4>
                                        ...
                                        <div className="slick-slide slick-cloned" data-slick-index="-2" aria-hidden="true" tabIndex="-1">
                                            <div className="media test_desc">
                                                <div className="">
                                                    ...
                                                    <div className="media-body  text-justify" data-toggle="modal" data-target="#customer_1">
                                                        <h4 className="media-heading">
                                                            <span id="">Arvind Bhattacharya</span><div className="clearfix">
                                                            </div>
                                                            <small>
                                                                <span id="">March 21,2020</span></small></h4>
                                                    ...
                                                    <div className="slick-slide slick-active" data-slick-index="1" aria-hidden="false" tabIndex="-1" role="option">
                                                        <div className="media test_desc">
                                                            <div className="">
                                                                ...
                                                                <div className="media-body text-justify" data-toggle="modal" data-target="#customer_1">
                                                                    <h4 className="media-heading">
                                                                        <span id="ctl00_lblCust2">Roshni Jain</span>
                                                                        <div className="clearfix">
                                                                        </div>
                                                                        <small>
                                                                            <span id="ctl00_lblCustDate2">January 27,2020</span></small></h4>
                                                                    <span id="ctl00_lblCustDeatils2" className="para_max">Thank you and I will ensure that the cheque is sent today evening or tomorrow at the latest. I would like to thank you for your prompt, courteous, helpful and efficient service. I am extremely happy with InsuringIndia Quotation of motor (Four wheeler) and nice cooperation to with which the transaction was completed and I will certainly recommend you to all my friends and colleagues.</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="slick-slide slick-active" data-slick-index="2" aria-hidden="false" tabIndex="-1" role="option">
                                                            <div className="media test_desc">
                                                                <div className="">
                                                                    ...
                                                                    <div className="media-body  text-justify" data-toggle="modal" data-target="#customer_1">
                                                                        <h4 className="media-heading">
                                                                            <span id="ctl00_lblCust3">Rahul Sharma</span><div className="clearfix">
                                                                            </div>
                                                                            <small>
                                                                                <span id="ctl00_lblCustDate3">January 10,2019</span></small></h4>
                                                                ...
                                                                <div className="media test_desc">
                                                                    <div className="">
                                                                        ...
                                                                        <div className="media-body  text-justify" data-toggle="modal" data-target="#customer_1">
                                                                            <h4 className="media-heading">
                                                                                <span id="ctl00_lblCust4">Arvind Bhattacharya</span><div className="clearfix">
                                                                                </div>
                                                                                <small>
                                                                    ...
                                                                    <div className="media test_desc">
                                                                        <div className="">
                                                                            ...
                                                                            <div className="media-body  text-justify" data-toggle="modal" data-target="#customer_1">
                                                                                <h4 className="media-heading">
                                                                                    <span id="ctl00_lblCust5">Kanika Mehra</span>
                                                                                    <div className="clearfix">
                                                                                    </div>
                                                                                    <small>
                                                                                        <span id="ctl00_lblCustDate5">December 15,2019</span></small></h4>
                                                                        ...
                                                                        <div className="media test_desc">
                                                                            <div className="">
                                                                                ...
                                                                                <div className="media-body text-justify" data-toggle="modal" data-target="#customer_1">
                                                                                    <h4 className="media-heading">
                                                                                        <span id="">Aditi Raikar</span><div className="clearfix">
                                                                                        </div>
                                                                                        <small>
                                                                                            <span id="">September 27,2019</span></small></h4>
                                                                            ...
                                                                            <div className="media test_desc">
                                                                                ...
                                                                                <div className="media test_desc">
                                                                                    <div className="">
                                                                                        ...
                                                                                        <div className="media-body  text-justify" data-toggle="modal" data-target="#customer_1">
                                                                                            <h4 className="media-heading">
                                                                                                <span id="">Rahul Sharma</span><div className="clearfix">
                                                                                                </div>
                                                                                                <small>
                                                                                                    <span id="">January 10,2019</span></small></h4>
                                                                                            <span id="" className="para_max">Got the insurance policy. I was in urgent need of the policy as I have to appear for the visa interview tomorrow morning and that's why I called the executive of Insuringindia and booked online policy and download also got it through mail. Very nice multi language insurance portal in India.</span>
                                                                            ...
                                                                            <button type="button" data-role="none" className="slick-next slick-arrow" aria-label="Next" role="button" style={{display: 'block'}}><i className="fa fa-angle-right color_grey"></i></button></section></div>
                                                                </div>
                                                                {/* <!-- .container-fluid --> */}
        </section>
        </React.Fragment>
