        ...
        <div className="row">
            ...
            <div className="col-xs-12 col-md-4">
                <div className="footer_social text-center">
                    <a href="http://www.facebook.com/pages/Insuring-India/185072224855280" target="_blank">
                ...
                <div className="text-center">
                    <img alt="" src="/images/master/QR_code.png" className="img-responsive scan_image" />
                    <p className="copy_text">
                        <span id="ctl00_Footer1_lblBarCode">Scan the QR code from your mobile device to access mobile version of insuringindia.com</span>
                    </p>
                    <p className="copy_text">
                        <span id="ctl00_Footer1_lblftrInsuranceSolitication">Insurance is the subject matter of solicitation</span>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div className="container-fluid">
        <div className="row">
            <div className="col-md-12">
                ...
                <p className="copy_text">
                    <span id="ctl00_Footer1_FooterContent2">© 2011 InsuringIndia.com and Great Indian Insurance Web Aggregators Pvt. Ltd. <div className="clearfix"></div><p className="copy_text fontstyle2">Website Approved by the IRDA (Govt. of India)<br />Regn. No. IRDA/WBA/26/01/2015</p></span>
                </p>
                <p className="copy_text">
                    <span id="ctl00_Footer1_lblFooterContent3">All the images used on InsuringIndia.com have either been purchased or are used with permission of the copyright holder. Images from InsuringIndia.com may not be copied or used elsewhere without obtaining  appropriate permissions from the copyright holders.<div className="clearfix"></div>All Rights reserved</span>
                </p>
